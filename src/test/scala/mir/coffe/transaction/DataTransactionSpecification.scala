...
import mir.coffe.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, DataEntry, EitherExt2, IntegerDataEntry, StringDataEntry}
...
import mir.coffe.api.http.SignedDataRequest
