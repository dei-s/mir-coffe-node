...
import mir.coffe.features.BlockchainFeatureStatus.{Activated, Approved, Undefined}
import mir.coffe.features.api.NodeFeatureStatus.{Implemented, NotImplemented, Voted}
